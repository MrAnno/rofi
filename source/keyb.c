...
DefaultBinding bindings[NUM_ABE] =
{
    ...
    { .id = MODE_PREVIOUS,           .name = "kb-mode-previous",           .keybinding = "Shift+Left,Control+Shift+Tab,Control+ISO_Left_Tab",      .comment = "Switch to the previous mode."                                    },
    ...
    { .id = ROW_UP,                  .name = "kb-row-up",                  .keybinding = "Up,Control+p,Shift+Tab,ISO_Left_Tab",                    .comment = "Select previous entry"                                           },
